...
!(function(e, t) {
  ...
  var D,
    ...
    M = A.inspectSource,
    j = r.WeakMap,
    U = 'function' == typeof j && /native code/.test(M(j)),
    V = t(function(e) {
  ...
  var X,
    ...
    fe = function(e) {
      return function(t, n, r) {
        var i,
          ...
          s = pe(r, a)
        if (e && n != n) {
          for (; a > s; ) if ((i = o[s++]) != i) return 1
        } else
          for (; a > s; s++) if ((e || s in o) && o[s] === n) return e || s || 0
        return !e && -1
      }
    },
    he = { includes: fe(1), indexOf: fe(0) },
    me = he.indexOf,
    ve = function(e, t) {
      var n,
        r = m(e),
    ...
    Te = function(e, t) {
      var n = Ce[we(e)]
      return n == Ie ? 1 : n == Ee ? 0 : 'function' == typeof t ? i(t) : !!t
    },
    ...
    Ae = function(e, t) {
      ...
      if ((n = u ? r : d ? r[c] || x(c, {}) : (r[c] || {}).prototype))
        for (i in t) {
          ...
          ;(e.sham || (o && o.sham)) && P(a, 'sham', 1), te(n, i, a, e)
        }
    },
    Oe =
      Array.isArray ||
    ...
    je = V('wks'),
    Ue = r.Symbol,
    Ve = Me ? Ue : (Ue && Ue.withoutSetter) || B,
    Fe = function(e) {
      return (
        y(je, e) ||
          (Ne && y(Ue, e) ? (je[e] = Ue[e]) : (je[e] = Ve('Symbol.' + e))),
        je[e]
      )
    },
    Ge = Fe('species'),
  ...
  Ae(
    { target: 'Array', proto: 1, forced: !Qe || !Xe },
    {
      concat: function(e) {
        var t,
          n,
  ...
  Ae(
    { target: 'Array', proto: 1, forced: !at || !st },
    {
      filter: function(e) {
  ...
  Ae(
    { target: 'Array', proto: 1, forced: !ut || !dt },
    {
      map: function(e) {
  ...
  function Nt(e) {
    ...
    if (t.mozGetUserMedia)
      ...
      (0 == e.isSecureContext && e.webkitRTCPeerConnection && !e.RTCIceGatherer)
    )
      (n.browser = 'chrome'),
  ...
  function Ft(e) {
    ...
    const n = Nt(e),
      ...
      i = function(e, i) {
        ...
        return Vt('chrome: ' + JSON.stringify(e)), i(e)
      },
      o = function(e) {
        return n.version >= 64
          ? e
      ...
      if (arguments.length > 0 && arguments[0] instanceof e.MediaStreamTrack) {
        ...
        return (
          ...
          this.getReceivers().forEach(
            t => (t.track === e && (n ? (r = 1) : (n = t)), t.track === e)
          ),
          r || (t && n)
            ? Promise.reject(
                new DOMException(
  ...
  var rn = function(e, t) {
    ...
    Object.defineProperty(i.prototype, 'localDescription', {
      ...
      (i.prototype._createIceGatherer = function(t, n) {
        ...
        return (
          Object.defineProperty(i, 'state', { value: 'new', writable: 1 }),
      ...
      (i.prototype._createIceAndDtlsTransports = function() {
        ...
        return (
          ...
          (r.onerror = function() {
            Object.defineProperty(r, 'state', { value: 'failed', writable: 1 }),
              t._updateConnectionState()
          }),
        ...
        return (
          ...
          c.forEach(function(r, c) {
            ...
            if (
              ...
              o.transceivers[c] = { mid: _, kind: f, protocol: m, rejected: 1 }
            else {
              var y, S, b, k, R, T, w, C, E
              !h &&
                o.transceivers[c] &&
                o.transceivers[c].rejected &&
                (o.transceivers[c] = o._createTransceiver(f, 1))
              var I,
                P,
      ...
      (i.prototype.createOffer = function() {
        ...
        for (
          n.transceivers.forEach(function(e) {
            'audio' === e.kind
              ? --r < 0 && (e.wantReceive = 0)
              : 'video' === e.kind && --i < 0 && (e.wantReceive = 0)
          });
          r > 0 || i > 0;
    ...
    e.RTCPeerConnection.prototype.createOffer = function(e) {
      if (e) {
        ...
        0 == e.offerToReceiveAudio && t
          ...
          : 1 != e.offerToReceiveAudio || t || this.addTransceiver('audio'),
        ...
        0 == e.offerToReceiveVideo && n
          ...
          : 1 != e.offerToReceiveVideo || n || this.addTransceiver('video')
      }
      return t.apply(this, arguments)
    }
  }
  ...
  const Dn = (function(
    { window: e } = {},
    t = { shimChrome: 1, shimFirefox: 1, shimEdge: 1, shimSafari: 1 }
  ) {
    const n = Dt,
      r = Nt(e),
      i = {
  ...
  var Ln = function(e, t) {
    ...
    Un = Ln('indexOf')
  Ae(
    { target: 'Array', proto: 1, forced: jn || Un },
    {
      indexOf: function(e) {
        return jn
  ...
  var Vn = Fe('species'),
    ...
    Gn = Math.max
  Ae(
    { target: 'Array', proto: 1, forced: !$e('slice') },
    {
      slice: function(e, t) {
        var n,
          r,
  ...
  Ae({ target: 'Function', proto: 1 }, { bind: Wn })
  var Jn = I.f,
  ...
  var or = tr
  Ae({ target: 'RegExp', proto: 1, forced: /./.exec !== or }, { exec: or })
  var ar = (function() {
    var e = function() {},
      t = 'undefined',
  ...
  Ae({ target: 'Array', stat: 1 }, { isArray: Oe })
  var sr = [].join,
    cr = f != Object,
    ur = Ln('join', ',')
  Ae(
    { target: 'Array', proto: 1, forced: cr || ur },
    {
      join: function(e) {
  ...
  var dr = it.some
  Ae(
    { target: 'Array', proto: 1, forced: Ln('some') },
    {
      some: function(e) {
  ...
  var lr = Math.max,
    pr = Math.min
  Ae(
    { target: 'Array', proto: 1, forced: !$e('splice') },
    {
      splice: function(e, t) {
        var n,
          r,
        ...
        for (i = Be(c, r), o = 0; o < r; o++) (a = d + o) in c && Le(i, o, c[a])
        if (((i.length = r), n < r)) {
          for (o = d; o < u - r; o++)
  ...
  var fr =
    ...
    br =
      ...
      !i(function() {
        ...
        ? function() {
            if (!isFinite(yr.call(this))) throw RangeError('Invalid time value')
        ...
        : Sr
  Ae(
    { target: 'Date', proto: 1, forced: Date.prototype.toISOString !== br },
    { toISOString: br }
  )
  ...
  Ae(
    { target: 'Object', stat: 1, forced: !o || Cr, sham: !o },
    {
  ...
  Ae(
    { target: 'Object', stat: 1, forced: Ar, sham: !Er },
    {
  ...
  Dr || te(Object.prototype, 'toString', jr, { unsafe: 1 })
    ...
    te(
      ...
      function() {
        ...
        return (
          ...
          '/' +
          String(
            void 0 === n && e instanceof RegExp && !('flags' in Ur)
              ? Yn.call(e)
              : n
          )
        )
        ...
        var c = /./[o],
          u = n(
            ...
            function(e, t, n, r, i) {
              return t.exec === or
                ? a && !i
                  ? { done: 1, value: c.call(t, n, r) }
                  : { done: 1, value: e.call(n, t, r) }
                : { done: 0 }
            },
            { REPLACE_KEEPS_$0: zr }
          ),
  ...
  var Yi = {
      nextTick: function(e) {
        ...
        Di.push(new Ui(e, t)), 1 !== Di.length || Li || Ai(ji)
      },
      title: 'browser',
      browser: 1,
      env: {},
  ...
  var bo,
    ...
    wo = function() {
      var e = new Date()
      return e.setTime(To()), e.toISOString()
    }
  function Co(e) {
    try {
  ...
  ;(ar.setConfig = function(e) {
    ...
    (ar.enableUploadLog = function() {
      Wo || (ar.info('enable upload log'), Ho(ar), (Wo = 1))
    }),
  ...
  var ea =
    ...
    da = function(e, t, n) {
      e &&
        ...
        ca(e, ua, { configurable: 1, value: t })
    },
    la = it.forEach,
    pa = z('hidden'),
    fa = Fe('toPrimitive'),
    ...
    Ra = V('symbols'),
    Ta = V('op-symbols'),
    wa = V('string-to-symbol-registry'),
    Ca = V('symbol-to-string-registry'),
    Ea = V('wks'),
    Ia = r.QObject,
    ...
    Da = function(e, t, n) {
      ...
      return (
        ...
        y(Ra, r)
          ? (n.enumerable
              ? (y(e, pa) && e[pa][r] && (e[pa][r] = 0),
                (n = ea(n, { enumerable: u(0, 0) })))
              : (y(e, pa) || Sa(e, pa, u(1, {})), (e[pa][r] = 1)),
            xa(e, r, n))
          : Sa(e, r, n)
      )
    },
    ...
    Na = function(e) {
      var t = g(e, 1),
        n = ka.call(this, t)
      return this === va && y(Ra, t) && !y(Ta, t)
        ? 0
        : n || !y(this, t) || !y(Ra, t) || (y(this, pa) && this[pa][t])
        ? n
        : 1
    },
    Ma = function(e, t) {
      ...
      if (n !== va || !y(Ra, r) || y(Ta, r)) {
        var i = ya(n, r)
        return (
          !i || !y(Ra, r) || (y(n, pa) && n[pa][r]) || (i.enumerable = 1), i
        )
      }
    },
    ja = function(e) {
  ...
  if (
    (Ne ||
      (te(
        (ga = function() {
          ...
          var e =
            ...
            n = function(e) {
              this === va && n.call(Ta, e),
                y(this, pa) && y(this[pa], t) && (this[pa][t] = 0),
                xa(this, t, u(1, e))
            }
          return o && Pa && xa(va, t, { configurable: 1, set: n }), Aa(t, e)
        }).prototype,
        'toString',
        function() {
          return ma(this).tag
      ...
      o &&
        ...
        te(va, 'propertyIsEnumerable', Na, { unsafe: 1 }))),
    Ae({ global: 1, wrap: 1, forced: !Ne, sham: !Ne }, { Symbol: ga }),
    la(qo(Ea), function(e) {
      sa(e)
    }),
    Ae(
      { target: 'Symbol', stat: 1, forced: !Ne },
      {
        for: function(e) {
          var t = String(e)
    ...
    Ae(
      { target: 'Object', stat: 1, forced: !Ne, sham: !o },
      {
        create: function(e, t) {
    ...
    Ae(
      { target: 'Object', stat: 1, forced: !Ne },
      { getOwnPropertyNames: ja, getOwnPropertySymbols: Ua }
    ),
    Ae(
      {
        target: 'Object',
  ...
  if (
    ...
    Fa(za, 'description', {
      ...
      Ae({ global: 1, forced: 1 }, { Symbol: Ha })
  }
  sa('iterator')
  var Ka = it.forEach,
    $a = Ln('forEach')
      ...
      : [].forEach
  Ae({ target: 'Array', proto: 1, forced: [].forEach != $a }, { forEach: $a })
  var Ya = Fe('unscopables'),
    Qa = Array.prototype
  null == Qa[Ya] && I.f(Qa, Ya, { configurable: 1, value: ea(null) })
  var Xa,
    Za,
    es,
    ts = function(e) {
  ...
  var os = { IteratorPrototype: Xa, BUGGY_SAFARI_ITERATORS: is },
    ...
    fs = function(e, t, n, r, i, o, a) {
      !(function(e, t, n) {
        var r = t + ' Iterator'
        ;(e.prototype = ea(as, { next: u(1, n) })), da(e, r, 0), (ns[r] = ss)
      })(n, t, r)
      var s,
        c,
        d,
      ...
      if (
        ...
        else Ae({ target: t, proto: 1, forced: ds || f }, c)
      return c
    },
    hs = ee.set,
    ...
    vs = fs(
      ...
      function() {
        var e = ms(this),
          ...
          r = e.index++
        return !t || r >= t.length
          ? ((e.target = void 0), { value: void 0, done: 1 })
          : 'keys' == n
          ? { value: r, done: 0 }
          : 'values' == n
          ? { value: t[r], done: 0 }
    ...
    Us =
      ((function(e, t, n) {
          ...
          p = function(e) {
            ...
            te(
              ...
              'add' == e
                ...
                : 'delete' == e
                ? function(e) {
                    return a && !v(e) ? 0 : t.call(this, 0 === e ? 0 : e)
                  }
                : 'get' == e
                ? function(e) {
        ...
        if (
          ...
          (d = n.getConstructor(t, e, o, s)), (_s.REQUIRED = 1)
        else if (Pe(e, 1)) {
          var f = new d(),
            h = f[s](a ? {} : -0, 1) != f,
            m = i(function() {
              ...
              function() {
                ...
                return e.target && (e.last = n = n ? n.next : e.state.first)
                  ? 'keys' == t
                    ? { value: n.key, done: 0 }
                    : 'values' == t
                    ? { value: n.value, done: 0 }
                    : { value: [n.key, n.value], done: 0 }
                  : ((e.target = void 0), { value: void 0, done: 1 })
              },
              n ? 'entries' : 'values',
              !n,
  ...
  var rc = Hs.trim,
    ...
    oc = /^[+-]?0[Xx]/,
    ac =
      8 !== ic(Us + '08') || 22 !== ic(Us + '0x16')
        ? function(e, t) {
            var n = rc(String(e))
            return ic(n, t >>> 0 || (oc.test(n) ? 16 : 10))
          }
        : ic
  Ae({ global: 1, forced: parseInt != ac }, { parseInt: ac })
  var sc,
    cc,
    uc,
    dc = r.Promise,
  ...
  ;(fc && hc) ||
    ...
    'process' == l(mc)
      ...
      : ((sc = Rc), r.addEventListener('message', kc, 0)))
  var Tc,
    wc,
    Cc,
    Ec,
    ...
    jc = r.Promise,
    Uc = 'process' == l(Mc),
    Vc = Dc(r, 'queueMicrotask'),
    Fc = Vc && Vc.value
  Fc ||
    ((Tc = function() {
      var e, t
      for (Uc && (e = Mc.domain) && e.exit(); wc; ) {
        ;(t = wc.fn), (wc = wc.next)
        try {
          t()
        } catch (vf) {
          throw (wc ? Ec() : (Cc = void 0), vf)
        }
      }
      ;(Cc = void 0), e && e.enter()
    }),
    Uc
      ...
      ? ((Ic = 1),
        ...
        new Nc(Tc).observe(Pc, { characterData: 1 }),
        (Ec = function() {
          Pc.data = Ic = !Ic
        }))
      : jc && jc.resolve
  ...
  var Gc,
    ...
    lu = Pe(Xc, function() {
      if (!(M(nu) !== String(nu))) {
        if (66 === qe) return 1
        if (!uu && 'function' != typeof PromiseRejectionEvent) return 1
      }
      if (qe >= 51 && /native code/.test(nu)) return 0
      var e = nu.resolve(1),
        t = function(e) {
          e(
            function() {},
    ...
    fu = function(e) {
      var t
      return v(e) && 'function' == typeof (t = e.then) ? t : 0
    },
    hu = function(e, t, n) {
      if (!t.notified) {
        t.notified = 1
        ...
        Wc(function() {
          ...
          ;(t.reactions = []), (t.notified = 0), n && !t.rejection && vu(e, t)
        })
      }
    },
    mu = function(e, t, n) {
    ...
    _u = function(e, t) {
      Yc.call(r, function() {
        uu ? ou.emit('rejectionHandled', e) : mu('rejectionhandled', e, t.value)
      })
    },
    yu = function(e, t, n, r) {
      return function(i) {
    ...
    Su = function(e, t, n, r) {
      t.done ||
        ((t.done = 1), r && (t = r), (t.value = n), (t.state = 2), hu(e, t, 1))
    },
    bu = function(e, t, n, r) {
      if (!t.done) {
        ;(t.done = 1), r && (t = r)
  ...
  lu &&
    ...
    ((Gc = function(e) {
      ...
      then: function(e, t) {
        var n = tu(this),
          r = su(ai(this, nu))
        return (
          (r.ok = 'function' == typeof e ? e : 1),
          (r.fail = 'function' == typeof t && t),
          (r.domain = uu ? ou.domain : void 0),
          (n.parent = 1),
          n.reactions.push(r),
          0 != n.state && hu(this, n, 0),
          r.promise
        )
      },
      catch: function(e) {
    ...
    'function' == typeof dc &&
      ...
      'function' == typeof au &&
        Ae(
          { global: 1, enumerable: 1, forced: 1 },
          {
            fetch: function(e) {
    ...
    Ae({ global: 1, wrap: 1, forced: lu }, { Promise: nu }),
    da(nu, Xc, 0),
    Ds(Xc),
    (Hc = ie(Xc)),
    Ae(
      { target: Xc, stat: 1, forced: lu },
      {
        reject: function(e) {
          var t = su(this)
  ...
  fs(
    ...
    function() {
      ...
      return r >= n.length
        ? { value: void 0, done: 1 }
        : ((e = ku(n, r)), (t.index += e.length), { value: e, done: 0 })
    }
  )
  var wu,
    Cu = function(e) {
  ...
  Ae(
    { target: 'String', proto: 1, forced: !Ou && !Au },
    {
  ...
  Ae(
    { target: 'Object', stat: 1, forced: zu },
    {
      keys: function(e) {
        return qo(De(e))
      }
  ...
  var Wu = c.f,
    ...
    qu = { entries: Ju(1), values: Ju(0) }.values
  Ae(
    { target: 'Object', stat: 1 },
    {
      values: function(e) {
        return qu(e)
      }
  ...
  if (
    ...
    Pe(
      ...
      !nd ||
        ...
        i(function() {
          return (
            (td[Qu] = 0), Xu(ed) != ed || Xu(td) == td || '/a/i' != Xu(ed, 'i')
          )
        })
    )
  ) {
  ...
  var ud = Hs.trim,
    ...
    ld =
      1 / dd(Us + '-0') != -Infinity
        ...
        : dd
  Ae({ global: 1, forced: parseFloat != ld }, { parseFloat: ld })
  var pd = (window.navigator && window.navigator.userAgent) || '',
    ...
    Ed =
      ...
      /Windows/i.test(pd)),
    Id = /MAC OS X/i.test(pd),
    Pd = /Linux/i.test(pd),
    xd =
      (/MicroMessenger/i.test(pd),
      kd ? 'Chrome/' + Rd : Td ? 'Safari/' + wd : 'NotSupportedBrowser'),
    Ad = function(e) {
    ...
    if (Ld(e))
      switch (Object.prototype.toString.call(e)) {
        ...
        case '[object Set]':
          return 0 === e.size
        case '[object Object]':
          for (var t in e) if (Nd.call(e, t)) return 0
          return 1
      }
    return 0
  }
  var jd,
    Ud = t(function(e) {
      ...
      Object.create &&
        ((r.prototype = Object.create(null)), new r().__proto__ || (n = 0)),
        ...
        (s.prototype.emit = function(e, t, r, i, o, a) {
          ...
          if (d.fn) {
            ...
            for (u = 0; u < f; u++)
              switch (
                (d[u].once && this.removeListener(e, d[u].fn, void 0, 1), l)
              ) {
                case 1:
    ...
    zd = 'on_peer_sdp',
    Wd = 'on_reexchange_sdp',
    Jd = 'on_create_room',
    qd = 'on_close_peer',
    Kd = 'on_quality_report',
    $d = 'on_rebuild_session',
    Yd = 'on_change_av_state',
    Qd = 'on_subscribe',
    Xd = 'on_constraints_config',
    Zd = 'on_test_ws_broken',
    el = 'on_recreate_down_peerc',
    tl = {
    ...
    nl = (function(e) {
      function t(e) {
        var n,
          r = e.message,
          i = e.code,
          o = void 0 === i ? tl.UNKOWN : i,
          a = e.extraCode,
          s = void 0 === a ? 0 : a
        return (
          ht(this, t),
          ((n = Tt(this, St(t).call(this, r))).code_ = o),
          (n.extraCode_ = s),
          (n.name = 'RtcError'),
          n
        )
    ...
    rl = { sdkAppId: '', userId: '', version: '', env: 'qcloud' },
    il = function(e) {
      ;(rl.sdkAppId = ''.concat(e.sdkAppId)),
        (rl.version = ''.concat(e.version)),
        (rl.env = e.env),
        (rl.userId = e.userId)
    },
    ol = function(e) {
    ...
    Ll = function(e, t) {
      var n = Dl.get(e)
      n || (Dl.set(e, []), (n = Dl.get(e))), n.push(t)
    },
    Nl = function(e) {
      var t = Dl.get(e)
      return t ? Dl.delete(e) : (t = []), t
    },
    Ml = 3,
    jl = (function() {
      function e(t) {
        ht(this, e),
          ...
          (this.signalInfo_ = {}),
          (this.currentState_ = Gd.DISCONNECTED),
          (this.emitter_ = new Ud())
      }
      return (
        vt(e, [
          {
            ...
            value: function() {
              ...
              ar.info('connect to url: '.concat(this.urlWithParam_)),
                ...
                (this.currentState_ = Gd.CONNECTING),
            ...
            value: function(e) {
              if (!this.isConnected_) {
                ...
                ar.info(
                  ...
                  (this.currentState_ = Gd.CONNECTED)
              }
            }
          },
          {
            ...
            value: function(e) {
              ...
              if (this.isConnected_) {
                var n = JSON.parse(e.data),
                  ...
                  i = n.content,
                  o = Object.values(Bd),
                  a = Object.keys(Bd)[o.indexOf(r)],
                  s = Hd[a]
                if (r !== Bd.UPDATE_REMOTE_MUTE_STAT) {
                ...
                switch (r) {
                  case Bd.CHANNEL_SETUP_SUCCESS:
                    ;(this.signalInfo_.relayIp = i.relayip),
                      ...
                      1 === (i.rc || 0)
                        ? this.emitter_.emit(Hd.REQUEST_REBUILD_SESSION, {
                  ...
                  case Bd.CHANNEL_SETUP_FAILED:
                    ...
                    void 0 !== i.errorCode &&
                      ...
                      this.emitter_.emit(
                        Fd,
                        new nl({
                          code: tl.SIGNAL_CAHNNEL_SETUP_FAILED,
                    ...
                    break
                  case Bd.CHANNEL_RECONNECT_RESULT:
                    ;-1 === i.result &&
                      (ar.error(
              ...
              this.reconnectTimer_ = setTimeout(function() {
                ...
                Md(t.signalInfo_) ||
                  ...
                  t.emitter_.emit(Vd, {
                    ...
                    state: Gd.RECONNECTING
                  }),
                  (t.currentState_ = Gd.RECONNECTING),
    ...
    e.origin == window.location.origin &&
      (function(e) {
        if ('PermissionDeniedError' == e) {
          if (jd) return jd('PermissionDeniedError')
          throw new Error('PermissionDeniedError')
        }
        e.sourceId && jd && jd(e.sourceId, 1 == e.canRequestAudioTrack)
      })(e.data)
  })
  window.InstallTrigger
  var Ul = !!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0,
    Vl =
      (window.chrome,
      function() {
        var e = 0
            ...
            for (;;)
              switch ((e.prev = e.next)) {
                case 0:
                  ...
                  return e.abrupt('return', Hl)
                case 2:
                  return (t = Vl()), (e.next = 5), Fl()
                case 5:
                  return (
                    (n = e.sent),
                    (r = !Sd && t && n) ||
                      ar.error(
                        ''
                          .concat(xd, ' isWebRTCSupported: ')
                          .concat(t, ' isH264Supported: ')
                          .concat(n)
                      ),
                    (Bl = 1),
                    (Hl = r),
  ...
  var Jl = 1,
    ...
    Kl = 20,
    $l = 21,
    Yl = '5Y2wZK8nANNAoVw6dSAHVjNxrD1ObBM2kBPV',
    Ql = '224d130c-7b5c-415b-aaa2-79c2eb5a6df2',
    Xl = 2,
    Zl = 7,
    ep = it.find,
    tp = 1
  'find' in [] &&
    ...
    Ae(
      { target: 'Array', proto: 1, forced: tp },
      {
        find: function(e) {
          return ep(this, e, arguments.length > 1 ? arguments[1] : void 0)
        }
      }
    ),
    ts('find')
  var np = function() {
    ...
    op = 'stream-updated',
    ap = 'stream-published',
    sp = 'stream-subscribed',
    cp = 'error',
    up = 'connection-state-changed',
    dp = 'stream-added',
    lp = 'stream-removed',
    pp = 'stream-updated',
    fp = 'stream-subscribed',
    ...
    bp = 'client-banned',
    kp = 'error',
    Rp = 'player-state-changed',
    Tp = 'screen-sharing-stopped',
    wp = 'player-state-changed',
    Cp = (1).toFixed,
    Ep = Math.floor,
    Ip = function(e, t, n) {
      return 0 === t
  ...
  Ae(
    { target: 'Number', proto: 1, forced: Pp },
    {
      toFixed: function(e) {
        var t,
          n,
          ...
          d = function(e, t) {
            for (var n = -1, r = t; ++n < 6; )
              (r += e * s[n]), (s[n] = r % 1e7), (r = Ep(r / 1e7))
          },
          p = function(e) {
            for (var t = 6, n = 0; --t >= 0; )
              (n += s[t]), (s[t] = Ep(n / e)), (n = (n % e) * 1e7)
          },
          f = function() {
            for (var e = 6, t = ''; --e >= 0; )
              if ('' !== t || 0 === e || 0 !== s[e]) {
        ...
        if ((o < 0 && ((c = '-'), (o = -o)), o > 1e-21))
          if (
            ...
            for (d(Ip(10, r, 1), 0), r = t - 1; r >= 23; ) p(1 << 23), (r -= 23)
            p(1 << r), d(1, 1), p(2), (u = f())
  ...
  var xp = window.AudioContext || window.webkitAudioContext,
    Ap = null,
    Op = (function() {
      function e() {
        var t = this
              ...
              this.element_.addEventListener('playing', function(t) {
                ...
                this.track_.addEventListener('mute', function(t) {
                  e.log_.info('stream - audio track is muted'),
                    'PAUSED' !== e.state_ &&
                      ((e.state_ = 'PAUSED'),
                      e.emitter_.emit(wp, { state: e.state_, reason: 'mute' }))
                }),
      ...
      return (
        vt(e, [
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            ...
                            return (
                              ...
                              this.audioPlayer_.on(wp, function(e) {
                                n.emitter_.emit(Rp, {
                                  type: 'audio',
                                  state: e.state,
                                  reason: e.reason
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            ...
                            return (
                              ...
                              this.videoPlayer_.on(wp, function(e) {
                                n.emitter_.emit(Rp, {
                                  type: 'video',
                                  state: e.state,
                                  reason: e.reason
          ...
          },
          {
            ...
            value: function() {
              return (
                this.addRemoteEvent(1, 'audio'), this.doEnableTrack('audio', 0)
              )
            }
          },
          {
            ...
            value: function() {
              return (
                this.addRemoteEvent(1, 'video'), this.doEnableTrack('video', 0)
              )
            }
          },
          {
            ...
            value: function() {
              return (
                this.addRemoteEvent(0, 'audio'), this.doEnableTrack('audio', 1)
              )
            }
          },
          {
            ...
            value: function() {
              return (
                this.addRemoteEvent(0, 'video'), this.doEnableTrack('video', 1)
              )
            }
          },
          {
            ...
            value: function(e, t) {
              if (this.isRemote_ && this.client_) {
                ...
                Ll(n, {
                  eventId: 'audio' === t ? (e ? Tl : Cl) : e ? Rl : wl,
                  eventDesc: r,
    ...
    jp = (function(e) {
      function t(e) {
        var n
        ht(this, t)
        var r = _t({}, e, { isRemote: 1, type: e.type })
        return (
          ((n = Tt(this, St(t).call(this, r))).isInSubscriptionCycle_ = 0), n
        )
      }
      return (
        yt(t, Mp),
            ...
            return e.split(';').map(function(e) {
              return e.split(',').map(function(e) {
                ...
                return (
                  '~' !== e[0]
                    ? (t = n(e))
                    : ((t = n(e.substring(1, e.length))), (r = 1)),
                  { scid: t, paused: r }
                )
              })
            })
    ...
    Fp =
      ...
      Vp.parseFmtpConfig,
      Vp.parsePayloads,
      Vp.parseRemoteCandidates,
      Vp.parseImageAttributes,
      Vp.parseSimulcastStreamList,
      /%[sdv%]/g),
    Gp = function(e) {
      var t = 1,
        n = arguments,
        r = n.length
      return e.replace(Fp, function(e) {
        if (t >= r) return e
        var i = n[t]
        switch (((t += 1), e)) {
          case '%%':
    ...
    Bp = function(e, t, n) {
      ...
      return Gp.apply(null, r)
    },
    Hp = ['v', 'o', 's', 'i', 'u', 'e', 'p', 'c', 'b', 't', 'r', 'z', 'a'],
    zp = ['i', 'c', 'b', 'a'],
    Wp = {
      write: function(e, t) {
        ;(t = t || {}),
        ...
        var n = t.outerOrder || Hp,
          r = t.innerOrder || zp,
          i = []
        return (
          n.forEach(function(t) {
            Up[t].forEach(function(n) {
      ...
      parse: Vp.parse,
      parseFmtpConfig: Vp.parseFmtpConfig,
      parseParams: Vp.parseParams,
      parsePayloads: Vp.parsePayloads,
      parseRemoteCandidates: Vp.parseRemoteCandidates,
      parseImageAttributes: Vp.parseImageAttributes,
      parseSimulcastStreamList: Vp.parseSimulcastStreamList
    },
    Jp = function(e) {
      return Wp.parse(e)
    },
    ...
    $p = (function() {
      function e(t) {
        ht(this, e),
          ...
          (this.mutedState_ = 0),
          (this.subscribeState_ = { audio: 1, video: 1, auxiliary: 1 }),
        ...
        vt(e, [
          {
            ...
            value: function() {
              ...
              ;(this.peerConnection_ = new RTCPeerConnection(e)),
                (this.peerConnection_.onconnectionstatechange = this.onConnectionStateChange.bind(
                  this
                )),
                this.isUplink_ ||
            ...
            value: function() {
              ...
              this.log_.info('closing connection'),
                ...
                this.peerConnection_ &&
                  (this.peerConnection_.close(), (this.peerConnection_ = null)),
                this.isUplink_ ||
                  (this.remoteStreams_.forEach(function(t, n, r) {
                    var i = t
                    i.setConnection(null), e.emitter_.emit(ip, { stream: i })
                  }),
          ...
          },
          {
            ...
            value: function() {
              this.isUplink_ &&
                ...
                this.isUplink_ ||
                  (this.signalChannel_.on(
                    Hd.UPDATE_REMOTE_SDP,
                    this.onUpdateRemoteSdp,
                    this
                  ),
                  this.signalChannel_.on(
                    Hd.UPDATE_AUDIO_SSRC,
                    this.onUpdateAudioSSRC,
                    this
                  ),
                  this.signalChannel_.on(
                    Hd.UPDATE_VIDEO_SSRC,
          ...
          },
          {
            ...
            value: function(e) {
                  ...
                  return (
                    t.media.forEach(function(e) {
                      if (e.ssrcs) {
                        ...
                        if ('audio' === e.type) n.audio.push(Yl)
              ...
              al({ eventType: 'ontrack', kind: n.kind })
              var i = 0,
                o = this.remoteStreams_.get(t.id)
              if (void 0 === o) {
                var a = t.id === Yl ? 'main' : 'auxiliary'
                ;(o = new jp({
                  type: a,
                  userId: this.userId_,
                  client: this.client_
              ...
              o.setMediaStream(t),
                'audio' === n.kind
                  ...
                  : (o.hasVideo() &&
                    ...
                    o.setHasVideo(1)),
                i
                  ? this.emitter_.emit(rp, { stream: o })
                  : this.emitter_.emit(op, { stream: o })
            }
          },
          {
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              ...
                              (e.prev = 1),
                              (e.next = 4),
                              this.peerConnection_.createOffer(Kp)
                            )
                          case 4:
                            return (
                              (t = e.sent),
                          ...
                          case 7:
                            ;(n = this.peerConnection_.localDescription),
                              ...
                              this.signalChannel_.send(Wd, n, 0),
                ...
                function() {
                  t.log_.debug('accepted anwswer: ' + r),
                    ...
                    t.waitForUpdatedAnswer_ ||
                      ...
                      t.emitter_.emit(ap, { stream: t.localStream_ })),
            ...
            value: function(e) {
              ...
              if (
                ...
                ;(this.connectTimer_ = setTimeout(function() {
                  ...
                  al({ eventType: 'iceConnectionState', result: 'failed' }),
                    t.log_.error(e),
                    t.addTransportEvent('disconnected'),
                    (t.isErrorObserved_ = 1),
                    t.emitter_.emit(
                      cp,
                      new nl({ message: e, code: tl.ICE_TRANSPORT_ERROR })
                    )
                }, 1e4)),
                  this.emitter_.emit(up, { state: 'connecting' })
              ...
              if ('failed' === e.target.connectionState) {
                ...
                al({ eventType: 'iceConnectionState', result: 'failed' }),
                  ...
                  this.isErrorObserved_ ||
                    ...
                    this.emitter_.emit(
                      cp,
                      new nl({ message: n, code: tl.ICE_TRANSPORT_ERROR })
                    ))
              }
              if (
                ('connected' === e.target.connectionState ||
                  'completed' === e.target.connectionState) &&
                (al({ eventType: 'iceConnectionState', result: 'success' }),
                this.addTransportEvent('connected'),
                this.emitter_.emit(up, { state: 'connected' }),
          ...
          },
          {
            ...
            value: function(e) {
              var t = this
              e.forEach(function(e) {
                var n = qp(e.ssrcs[0].id),
                  r = n === Xl ? 'video' : n === Zl ? 'auxVideo' : 'audio'
                t.log_.info('['.concat(r, '] track was removed'))
                var i = 'auxVideo' === r ? Ql : Yl,
                  o = t.remoteStreams_.get(i)
                o &&
                  ((i !== Ql && 0 !== o.getMediaStream().getTracks().length) ||
                  o.isInSubscriptionCycle()
                    ? ('audio' === r ? o.setHasAudio(0) : o.setHasVideo(0),
                      t.emitter_.emit(op, { stream: o }))
                    : (t.log_.info('remote stream '.concat(i, ' removed')),
                      t.remoteStreams_.delete(i),
                      t.emitter_.emit(ip, { stream: o })))
              })
            }
          },
          {
              ...
              r.filter(function(e) {
                ...
                if ('audio' === e.type)
                    ...
                    (t = n.remoteStreams_.get(o)) &&
                      (0 === t.getMediaStream().getTracks().length
                        ? t.isInSubscriptionCycle() ||
                          ...
                          n.emitter_.emit(ip, { stream: t }))
                        : (t.setHasAudio(0),
                          n.emitter_.emit(op, { stream: t }))))
                else if (
                  ...
                  void 0 === r.ssrcs && 2 === e.ssrcGroups.length
                    ...
                    ? (n.log_.info('[main video] track was removed'), (a = 1))
          ...
          },
          {
            ...
            value: function(e) {
              ...
              this.peerConnection_
                ...
                .then(function() {
                  var e = t.peerConnection_.localDescription
                  t.signalChannel_.send(zd, e, t.tinyId_),
              ...
              if (this.hitTest(n)) {
                ...
                if (void 0 !== i) {
                  ...
                  this.log_.info(
                    ...
                    r &&
                      'subscribe' === i.type &&
                      this.emitter_.emit(sp, { stream: o })
                }
                ...
                n.log_.info(
                  ...
                  n.sendSubscription(e, 'subscribe', function(e) {
                    if (e) r()
                      ...
                      n.log_.error(t), i(new nl({ message: t }))
                    }
                  })
              })
            }
          },
          {
            ...
            value: function(e) {
              ...
              return new Promise(function(n, r) {
                'main' === e.getType()
                  ? ((t.subscribeState_.audio = 0),
                    (t.subscribeState_.video = 0))
                  : (t.subscribeState_.auxiliary = 0),
                  t.log_.info(
                    'unsubscribe '
                  ...
                  t.sendSubscription(e, 'unsubscribe', function(e) {
                    if (e) n()
                      ...
                      t.log_.error(i), r(new nl({ message: i }))
                    }
                  }),
                  t.addEventInternal(_l, 'unsubscribe audio'),
                  t.addEventInternal(gl, 'unsubscribe video')
              })
            }
          },
          {
          ...
          },
          {
            ...
            value: function(e) {
              'connected' === e
                ? this.addEventInternal(Ol, 'ice transport is connected')
                : this.addEventInternal(Al, 'ice transport is disconnected')
            }
          },
          {
        ...
        vt(e, [
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 10:
                            ;(e.prev = 10),
                              (e.t0 = e.catch(3)),
                              ar.warn('failed to getStats on sender connection')
                          case 13:
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              if (((this.prevReport_ = JSON.parse(JSON.stringify(t))), Md(n)))
                (t.AudioReportState.uint32_audio_enc_pkg_br =
                  ...
                  t.VideoReportState.VideoDecState.forEach(function(e) {
                    ;(e.uint32_video_recv_br =
                      (8 * e.uint32_video_recv_br) / 2),
                ...
                for (
                  ...
                  for (
                    ...
                    if (l.uint64_sender_uin === a) {
                      ;(o.packetsLost =
                        o.totalPacketsLost - l.totalPacketsLost),
                ...
                for (var p = 0; p < r; p++) {
                  for (
                    ...
                    if (_.uint64_sender_uin === v) {
                      ;(f.packetsLost =
                        f.totalPacketsLost - _.totalPacketsLost),
      ...
      function e(t) {
        if (
          ...
          void 0 !== t.sdpSemantics
            ...
            : Gl() && (this.sdpSemantics_ = 'unified-plan'),
          (this.sdkAppId_ = t.sdkAppId),
          (this.userId_ = t.userId),
          (this.log_ = new Np({
            id: 'c|' + this.userId_,
      ...
      return (
        vt(e, [
          ...
          },
          {
            ...
            value: function(e) {
              var t = Dd(e)
              return !Od() && this.proxy_ && (t = this.proxy_), t
            }
          },
          {
            key: 'getBackupUrl',
            value: function() {
              return this.proxy_ ? this.proxy_ : Dd('wss://bk.rtc.qq.com:8687')
            }
          },
          {
            key: 'getUserId',
            ...
            value: function() {
              ...
              return new Promise(function(t, n) {
                e.log_.info('setup signal channel'),
                  ...
                  e.signalChannel_.on(Vd, function(t) {
                    e.log_.info(
                      'SignalChannel state changed from '
                        .concat(t.prevState, ' to ')
                        .concat(t.state)
                    ),
                      e.emitter_.emit(hp, t)
                  }),
                  e.signalChannel_.on(Fd, function(t) {
                    e.isInitialized_
                      ? (e.closeUplink(),
                        e.closeConnections(),
                        e.emitter_.emit(kp, t))
                      : n(t)
                  }),
                  e.signalChannel_.on(Hd.CHANNEL_SETUP_FAILED, function(t) {
                    e.log_.error('signal channel setup failed'), n(t)
                  }),
                  e.signalChannel_.on(Hd.CHANNEL_SETUP_SUCCESS, function(n) {
                    ;(e.signalInfo_ = n.signalInfo),
                      (e.tinyId_ = e.signalInfo_.tinyId),
                      (e.isInitialized_ = 1),
                      t()
                  }),
                  e.signalChannel_.on(Hd.PEER_JOIN, function(t) {
                    e.disableReceiver_ || e.onPeerJoin(t.data)
                  }),
                  e.signalChannel_.on(Hd.PEER_LEAVE, function(t) {
                    e.onPeerLeave(t.data)
                  }),
                  e.signalChannel_.on(Hd.UPDATE_REMOTE_MUTE_STAT, function(t) {
                    e.onUpdateRemoteMuteStat(t.data)
                  }),
                  e.signalChannel_.on(Hd.CLINET_BANNDED, function(t) {
                    ...
                    if (
                      ...
                      e.log_.error('Relay server timeout observed'),
                        e.emitter_.emit(
                          kp,
                          new nl({
                            code: tl.SERVER_TIMEOUT,
                            message: 'Relay server timeout observed'
                          })
                        )
                  }),
                  e.signalChannel_.on(Hd.REQUEST_REBUILD_SESSION, function(t) {
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 28:
                            ;(this.joinedTimestamp_ = new Date()),
                              ...
                              al({ eventType: 'join', result: 'success' })
                          case 32:
                          case 'end':
                            return e.stop()
                        }
              ...
              return new Promise(function(n, r) {
                ...
                var o,
                  ...
                  s = {
                    ...
                    browserVersion: xd,
                    closeLocalMedia: 1,
                    trtcscene: 'live' === t.mode_ ? ql : Jl,
                    trtcrole: 'anchor' === t.role_ ? Kl : $l,
                ...
                ;(t.joinTimeout_ = setTimeout(function() {
                  ...
                  t.signalChannel_.once(Hd.JOIN_ROOM_RESULT, function(e) {
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 15:
                            ;(this.isJoined_ = 0),
                              this.destroy(),
                              al({ eventType: 'leave', result: 'success' }),
                              (t = Math.floor(
                ...
                o.initialize(),
                  (t.publishTimeout_ = setTimeout(function() {
                    ;(t.isPublishing_ = 0),
                      ...
                      al({ eventType: 'publish', result: 'failed' }),
                      r(
                        new nl({ code: tl.UNKNOWN, message: 'publish timeout' })
                      )
                  }, 1e4)),
                  ...
                  o.on(ap, function(r) {
                    t.clearPublishTimeout(),
                      ...
                      al({ eventType: 'publish', result: 'success' })
                    var a = new Date()
                    al({
                  ...
                  o.on(cp, function(n) {
                    if (
                      n.getCode() === tl.ICE_TRANSPORT_ERROR &&
              ...
              return new Promise(function(n, r) {
                ...
                t.log_.info('unpublish() => unpublishing local stream'),
                  t
                    .doUnpublish()
                    .then(function() {
                      al({ eventType: 'unpublish', result: 'success' }), n()
                    })
                    .catch(function(e) {
                      al({ eventType: 'unpublish', result: 'failed' }), r()
                    })
              })
            }
          },
            ...
            value: function() {
              ...
              return new Promise(function(t, n) {
                e.signalChannel_.send(qd),
                  ...
                  e.signalChannel_.once(Hd.CLOSE_PEER_ACK, function(n) {
                    return (
                      e.clearUnpublishTimeout(),
                      e.log_.info(
          ...
          },
          {
            ...
            value: function(e) {
              ...
              a &&
                ...
                this.emitter_.emit(vp, { userId: r }),
                a.close(),
              ...
              s && (clearTimeout(s), this.pendingRefresh_.delete(i)),
                ...
                this.emitter_.emit(mp, { userId: r })
              var c = new $p({
                userId: r,
                tinyId: i,
                client: this,
              ...
              this.connections_.set(i, c),
                ...
                c.setRemoteOffer(o),
                c.on(rp, function(e) {
                  t.emitter_.emit(dp, { stream: e.stream })
                }),
                c.on(ip, function(e) {
                  t.emitter_.emit(lp, { stream: e.stream })
                }),
                c.on(op, function(e) {
                  t.emitter_.emit(pp, { stream: e.stream })
                }),
                c.on(sp, function(e) {
                  t.emitter_.emit(fp, { stream: e.stream })
                }),
                c.on(cp, function(e) {
                  var n = e.getCode(),
                    o = t.connectionsRefreshCount_.get(i)
                  if (n === tl.ICE_TRANSPORT_ERROR && o < 5) {
                    ;(o += 1),
                      t.connectionsRefreshCount_.set(i, o),
                      t.log_.warn('try to refresh remote peer ['.concat(r, ']'))
                    var a = { srctinyid: i }
                    t.signalChannel_.send(el, a)
                    ...
                    return (
                      (s = setTimeout(function() {
                        t.log_.warn('refresh remote peer timeout observed'),
                          c.emitter_.emit(kp, e)
                      }, 1e4)),
                      void t.pendingRefresh_.set(i, s)
                    )
                  }
                  t.emitter_.emit(kp, e)
                }),
                c.on(up, function(e) {
                  'connected' === e.state &&
                  ...
                  if (t.connections_.get(n)) {
                    ...
                    if (void 0 === c)
                      return (
                        ...
                        i &&
                          (s
                            ? t.emitter_.emit(_p, { userId: r })
                            : t.emitter_.emit(Sp, { userId: r })),
                        void (
                          o &&
                          (a
                            ? t.emitter_.emit(gp, { userId: r })
                            : t.emitter_.emit(yp, { userId: r }))
                        )
                      )
                    o &&
                      c.audioMuted !== a &&
    ...
    return {
      ...
      video:
        void 0 !== e.facingMode && e.video
          ...
          : e.video
          ? void 0 !== e.width
            ? { width: e.width, height: e.height, frameRate: e.frameRate }
            : 1
          : 0
    }
  }
  ...
  var rf = new Map()
  rf.set('120p', { width: 160, height: 120, frameRate: 15, bitrate: 200 }),
    rf.set('180p', { width: 320, height: 180, frameRate: 15, bitrate: 350 }),
    rf.set('240p', { width: 320, height: 240, frameRate: 15, bitrate: 400 }),
    rf.set('360p', { width: 640, height: 360, frameRate: 15, bitrate: 800 }),
    rf.set('480p', { width: 640, height: 480, frameRate: 15, bitrate: 900 }),
    rf.set('720p', { width: 1280, height: 720, frameRate: 15, bitrate: 1500 }),
    rf.set('1080p', { width: 1920, height: 1080, frameRate: 15, bitrate: 2e3 }),
    rf.set('1440p', {
      width: 2560,
      height: 1440,
      frameRate: 30,
    ...
    rf.set('4K', { width: 3840, height: 2160, frameRate: 30, bitrate: 9e3 })
  var of = new Map()
  of.set('480p', { width: 640, height: 480, frameRate: 5, bitrate: 900 }),
    of.set('480p_2', { width: 640, height: 480, frameRate: 30, bitrate: 1e3 }),
    of.set('720p', { width: 1280, height: 720, frameRate: 5, bitrate: 1200 }),
    of.set('720p_2', { width: 1280, height: 720, frameRate: 30, bitrate: 3e3 }),
    of.set('1080p', { width: 1920, height: 1080, frameRate: 5, bitrate: 1600 }),
    rf.set('1080p_2', {
      width: 1920,
      height: 1080,
      frameRate: 30,
  ...
  var af = new Map()
  af.set('standard', { sampleRate: 48e3, channelCount: 1, bitrate: 40 }),
    af.set('high', { sampleRate: 48e3, channelCount: 1, bitrate: 128 })
  var sf = (function(e) {
      function t(e) {
        var n
        ht(this, t)
        var r = _t({}, e, { isRemote: 0, type: 'local' })
        return (
          e.screen && (r.mirror = 0),
        ...
        vt(t, [
                ...
                if (void 0 === e.audio_) {
                  ...
                  return (
                    void 0 !== e.audioSource_ &&
                      (r.addTrack(e.audioSource_), e.setHasAudio(1)),
                    void 0 !== e.videoSource_ &&
                      (r.addTrack(e.videoSource_), e.setHasVideo(1)),
                    e.setMediaStream(r),
                    al({
          ...
          },
          {
            ...
            value: function(e) {
              ...
              'object' === lt(e)
                ? (t = e)
                : void 0 === (t = af.get(e)) && (t = af.get('standard')),
          ...
          },
          {
            ...
            value: function(e) {
              ...
              'object' === lt(e)
                ? (t = e)
                : void 0 === (t = rf.get(e)) && (t = rf.get('480p')),
  ...
  var uf,
    ...
    mf = {
      ...
      createClient: function(e) {
        hf.report('sdkAppID', { value: e.sdkAppId }),
          hf.report('version', { value: this.VERSION })
        var t = { version: this.VERSION }
        return new Qp(_t({}, t, e))
      },
  ...
  return (
    ...
    ar.info('TRTC Web SDK Version: ' + mf.VERSION),
